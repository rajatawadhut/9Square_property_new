...
public class SellAdapter extends RecyclerView.Adapter<SellAdapter.ShowData>{



    private List<SellDataModel> dataSet;
    private Context context;



    public SellAdapter(
            List<SellDataModel> dataSet, Context context) {
