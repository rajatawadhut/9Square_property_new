...
public class MyPropertyActivity extends AppCompatActivity {
    ...
    RecyclerView  recyclerviewmyproperty;
    ...
    private LinearLayout homeefooter, latestfooter, shortlistedfooter, searchfooter, addfooter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("getdatata :: " +date2);

        VolleySingleton.getInstance(getApplicationContext()).setmsgcounterdate(date2);
...
//            nav.inflateMenu(R.menu.activity_home_drawer3);
        ...
        recyclerviewmyproperty = findViewById(R.id.recyclerviewmyproperty);
        latestDataModels = new ArrayList<>();

        layoutManager = new GridLayoutManager(this, 2);
        recyclerviewmyproperty.setLayoutManager(layoutManager);
        latestAdapter = new LatestAdapter(latestDataModels,this);
        recyclerviewmyproperty.setAdapter(latestAdapter);





        recyclerviewmyproperty.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
        ...
        addfooter = findViewById(R.id.addfooter);
        ...
        homeefooter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent footorhome = new Intent(MyPropertyActivity.this, MainActivity.class);
        ...
        latestfooter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent footorhome = new Intent(MyPropertyActivity.this, LatestActivity.class);
                footorhome.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(footorhome);
            }
        });
        ...
        addfooter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(VolleySingleton.getInstance(getApplicationContext()).isLogin()){
                    ...
                    startActivity(new Intent(MyPropertyActivity.this, BasicDetails.class));
                }else{
        ...
        shortlistedfooter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent footorprofile = new Intent(MyPropertyActivity.this, ShortlistedActivity.class);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_home:
                        Intent intelp = new Intent(MyPropertyActivity.this, MainActivity.class);
                    ...
                    case R.id.testimonials:
                        Intent intel5 = new Intent(MyPropertyActivity.this, TestimonialsActivity.class);
                    ...
                    case R.id.addproperty:
                        ...
                        ListingData.getInstance(getApplicationContext()).Logout();
                        ListingData.getInstance(getApplicationContext()).setinstrance("Add");
                        Intent inte = new Intent(MyPropertyActivity.this, BasicDetails.class);
                    ...
                    case R.id.service:
                        Intent intemys = new Intent(MyPropertyActivity.this, Buyourservices.class);
                    ...
                    case R.id.buyproperty:
                        Intent intebuy = new Intent(MyPropertyActivity.this, SearchProperty.class);
                    ...
                    case R.id.userlist:
                        Intent intepu = new Intent(MyPropertyActivity.this, OwnerBuilderDeveloperList.class);
                    ...
                    case R.id.setting:
                        Intent intel = new Intent(MyPropertyActivity.this, SettingActivity.class);
                    ...
                    case R.id.profile:
                        Intent intep = new Intent(MyPropertyActivity.this, ProfileActivity.class);
                    ...
                    case R.id.shortlisted:
                        Intent intes = new Intent(MyPropertyActivity.this, ShortlistedActivity.class);
                    ...
                    case R.id.latest:
                        Intent intemy = new Intent(MyPropertyActivity.this, LatestActivity.class);
                    ...
                    case R.id.navabout:
                        Intent inta = new Intent(MyPropertyActivity.this, AboutActivity.class);
                    ...
                    case R.id.contact:
                        Intent intc = new Intent(MyPropertyActivity.this, ContactActivity.class);
                        intc.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intc);
                        drawer.closeDrawer(GravityCompat.START);
                        break;
                    case R.id.logout:
                        new AlertDialog.Builder(MyPropertyActivity.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Logout")
                                .setMessage("Are you sure?")
                                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        VolleySingleton.getInstance(getApplicationContext()).Logout();
                                        Intent intl = new Intent(MyPropertyActivity.this, LoginActivity.class);
...
//                    }
                    ...
                    LayoutInflater li = LayoutInflater.from(MyPropertyActivity.this);
            ...
            public void onErrorResponse(VolleyError error) {
                //progressDialog.dismiss();
                Toast.makeText(MyPropertyActivity.this,"Something Went Wrong",Toast.LENGTH_SHORT).show();
...
//        requestQueue.add(stringRequest);
    ...
    private void MyProperty() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Endpoints.getmyproperty, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                progressDialog.dismiss();
                progresscustom.setVisibility(View.GONE);
                ...
                try {
                    ...
                    if(succes.equals("1")){
                        for(int i=0; i<jsonArray.length();i++){
                            ...
                            else if(lasttimespinget.contains("2")){
                                lasttimespinget = "8 PM";
                            }
                            else if(lasttimespinget.contains("3")){
                                lasttimespinget = "9 PM";
                            }
                            else if(lasttimespinget.contains("4")){
                                lasttimespinget = "10 PM";
                            }
                            else if(lasttimespinget.contains("5")){
                                lasttimespinget = "11 PM";
                            }
                            else if(lasttimespinget.contains("6")){
                                lasttimespinget = "12 AM";
                            }
                            else if(lasttimespinget.contains("7")){
                                lasttimespinget = "1 AM";
                            }
                            else if(lasttimespinget.contains("8")){
                                lasttimespinget = "2 AM";
                            }
                            else if(lasttimespinget.contains("9")){
                                lasttimespinget = "3 AM";
                            }

                            else if(lasttimespinget.contains("10")){
    ...
    public void onBackPressed() {
        startActivity(new Intent(MyPropertyActivity.this, MainActivity.class));
        super.onBackPressed();
    }
