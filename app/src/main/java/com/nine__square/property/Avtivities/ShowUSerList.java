...
//        String listfor1, getcity1, type1, category1, min, max, sharing, usertype1;
    ...
    private void showsearch() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Endpoints.showuserlistproperty, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ShowUSerList.this,"Something Went Wrong",Toast.LENGTH_SHORT).show();
        ...
        VolleySingleton.getInstance(ShowUSerList.this).addToRequestQueue(stringRequest);
