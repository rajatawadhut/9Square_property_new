package com.nine__square.property.Helper;
...
/*
    ...
    ArrayList<String> lasttimespinget1 = new ArrayList<>();
                ...
                try {
                    ...
                    if(succes.equals("1")){
                        for(int i=0; i<jsonArray.length();i++){
                            ...
                            if(homethings.contains("1")){
                                homethings1.add("Wardrobe");
                            }


                            if(homethings.contains("2")){
                                homethings1.add("Modular Kitchen");
                            }


                            if(homethings.contains("3")){
                                homethings1.add("Fridge");
                            }


                            if(homethings.contains("4")){
                                homethings1.add("Ac");
                            }


                            if(homethings.contains("5")){
                                homethings1.add("Stove");
                            }


                            if(homethings.contains("6")){
                                homethings1.add("Geyser");
                            }


                            if(homethings.contains("7")){
                                homethings1.add("Dinning Table");
                            }

                            if(homethings.contains("8")){
                                homethings1.add("Sofa");
                            }


                            if(homethings.contains("9")){
                                homethings1.add("Washing Machine");
                            }


                            if(homethings.contains("10")){
                                homethings1.add("Water Purifier");
                            }


                            if(homethings.contains("11")){
                                homethings1.add("Microwave");
                            }


                            if(homethings.contains("12")){
                                homethings1.add("Curtains");
                            }

                            if(homethings.contains("13")){
                                homethings1.add("Chimney");
                            }

                            if(homethings.contains("14")){
                            ...
                            if(lasttimespinget.contains("1")){
                                lasttimespinget1.add("7 PM");
                            }
                            if(lasttimespinget.contains("2")){
                                lasttimespinget1.add("8 PM");
                            }
                            if(lasttimespinget.contains("3")){
                                lasttimespinget1.add("9 PM");
                            }
                            if(lasttimespinget.contains("4")){
                                lasttimespinget1.add("10 PM");
                            }
                            if(lasttimespinget.contains("5")){
                                lasttimespinget1.add("11 PM");
                            }
                            if(lasttimespinget.contains("6")){
                                lasttimespinget1.add("12 PM");
                            }
                            if(lasttimespinget.contains("7")){
                                lasttimespinget1.add("1 AM");
                            }
                            if(lasttimespinget.contains("8")){
                                lasttimespinget1.add("2 AM");
                            }
                            if(lasttimespinget.contains("9")){
                                lasttimespinget1.add("3 AM");
                            }

                            lasttimespinget = String.valueOf(lasttimespinget1);
