...
import com.nine__square.property.Avtivities.PlacePicker;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SelectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //This destroy the your activity class

                System.out.println("Logitude lat ::;"+ Lat + "  , "+ Long);
                Lat2 = String.valueOf(Lat);
                Long2 = String.valueOf(Long);
                LatLong = Lat2+","+Long2;

                VolleySingleton.getInstance(context).setsearchaddress(myAddress.getText().toString());
                ListingData.getInstance(context).setLatLog(LatLong);
